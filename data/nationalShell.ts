export interface DomainDef { id: string; label: string; description?: string; }
export interface IssueDef { id: string; domainId: string; label: string; description?: string; }
export interface IntakeQuestion { id: string; domainId: string; prompt: string; type: 'boolean' | 'text'; issueId?: string; }
export interface TestDef { id: string; issueId: string; label: string; description?: string; }

export const NATIONAL_DOMAINS: DomainDef[] = [
...
export const NATIONAL_ISSUES: IssueDef[] = [
...
export const NATIONAL_INTAKE: IntakeQuestion[] = [
...
export const NATIONAL_TESTS: TestDef[] = [
